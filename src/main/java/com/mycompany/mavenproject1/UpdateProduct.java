...
public class UpdateProduct extends JFrame {
	...
	public UpdateProduct() {
        ...
        ImageIcon img1 = new ImageIcon("C:\\All codes\\java code\\mavenproject1\\src\\main\\java\\com\\mycompany\\mavenproject1\\up.png");
        Image icon1 = img1.getImage().getScaledInstance(80,80,Image.SCALE_SMOOTH);
        JLabel lblNewLabel_2 = new JLabel(new ImageIcon(icon1));
        lblNewLabel_2.setBounds(86, 10, 106, 67);
        ...
        ImageIcon img3 = new ImageIcon("C:\\All codes\\java code\\mavenproject1\\src\\main\\java\\com\\mycompany\\mavenproject1\\update icon.png");
        ...
        btnNewButton_1.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		...
        		try {
        			...
        			st.executeUpdate("update product set pName='"+name+"', price='"+price+"', description='"+desc+"', activate='"+activate+"' where pId='"+pId+"'");
        			JOptionPane.showMessageDialog(null, "the Product is Successfully update");
        			setVisible(false);
